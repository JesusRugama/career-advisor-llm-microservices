...
# Helper to get Alembic config for conversations service
def get_alembic_config():
    # Path to alembic.ini in the conversations service root directory
    # Go up from tests -> src -> conversations-service root
