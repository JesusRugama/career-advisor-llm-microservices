...
class AIService:
    ...
    async def get_career_advice(self, user_profile: Dict[str, Any], question: Optional[str] = None) -> Dict[str, Any]:
    ...
    def _build_career_prompt(self, user_profile: Dict[str, Any], question: Optional[str] = None) -> str:
